document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      if (!consent) {
        alert('אנא אשר את הסכמתך לתנאים וההגבלות');
        return;
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "לביא חנות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '10902ae1-4ea2-4ea6-9606-ac1437c89fbe',
                    name: data.name || '',
                    email: data.email || '',
